# Tong Service IT Billing v4.1.10 Deploy Ready
...
## สิ่งที่เพิ่มใน v4.1.10

- แก้รายการเอกสารต้นทางไม่อัปเดตจาก HTTP `304 Not Modified`
- เพิ่มปุ่มโหลดเอกสารต้นทางใหม่ พร้อมสถานะกำลังโหลดและข้อความเมื่อไม่พบเอกสารที่ใช้ได้
- สร้างเอกสารต่อจากใบเดิมแล้วเลือกเอกสารต้นทางให้อัตโนมัติ

## สิ่งที่เพิ่มใน v4.1.9

- ลูกค้าบุคคลทั่วไปสร้างใบแจ้งหนี้ได้ทั้งแบบสร้างโดยตรงและสร้างต่อจากใบเสนอราคา
- รับชำระและออกใบเสร็จต่อจากใบแจ้งหนี้ของลูกค้าบุคคลทั่วไปได้
- เพิ่มสวิตช์ล็อกตำแหน่งช่องกรอก โดยเปิดล็อกเป็นค่าเริ่มต้น
- เมื่อปลดล็อกจะลากเรียงรายการได้จากไอคอนจับลากด้านซ้ายเท่านั้น
- แก้ Dropdown ลูกค้าให้โหลดรายชื่อทันทีเมื่อเปิดหน้าสร้างเอกสารครั้งแรก โดยไม่ต้องสลับไปหน้าเพิ่มลูกค้าก่อน

## สิ่งที่เพิ่มใน v4.1.8

- Preview กระดาษ A4 หลายหน้าที่ตรงกับ Print/PDF พร้อมเลขหน้าและหัวตารางซ้ำ
- แจ้งเตือนจำนวนหน้าก่อนพิมพ์ และไม่ลบรายการจริงเพื่อบังคับให้เหลือหน้าเดียว
- ส่งออก Excel `.xlsx` เป็นสำเนาที่แก้ไขภายนอกได้โดยไม่กระทบฐานข้อมูล
- แก้วันที่ออกเอกสารเดิมและเลือกคำนวณวันครบกำหนดใหม่ได้
- ตรวจผลกระทบเอกสารต้นทาง–ปลายทางก่อนลบหรือแก้รายการ
- คงข้อมูลลูกค้าเดิมเมื่อเปิดเอกสารมาแก้ไข
